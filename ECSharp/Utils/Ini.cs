...
namespace ECSharp.Utils
{
    ...
    public static class Ini
    {
        ...
        {
            internal readonly Dictionary<string, Dictionary<string, string>> map = new Dictionary<string, Dictionary<string, string>>();
        ...
        private readonly static Dictionary<string, IniParser> map = new Dictionary<string, IniParser>();
