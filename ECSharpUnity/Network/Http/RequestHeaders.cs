...
namespace ECSharp.Network.Http
{
    ...
    {
        internal static Dictionary<RequestHeaders, string> headerMap = new Dictionary<RequestHeaders, string>()
        {
            { RequestHeaders.CacheControl, "Cache-Control"},
            { RequestHeaders.Connection, "Connection" },
            { RequestHeaders.Date,"Date" },
            { RequestHeaders.KeepAlive,"Keep-Alive" },
            { RequestHeaders.Pragma,"Pragma" },
            { RequestHeaders.Trailer,"Trailer" },
            { RequestHeaders.TransferEncoding,"Transfer-Encoding" },
            { RequestHeaders.Upgrade, "Upgrade" },
            { RequestHeaders.Via,"Via" },
            { RequestHeaders.Warning,"Warning" },
            { RequestHeaders.Allow,"Allow" },
            { RequestHeaders.ContentLength,"Content-Length" },
            { RequestHeaders.ContentType,"Content-Type" },
            { RequestHeaders.ContentEncoding,"Content-Encoding" },
            { RequestHeaders.ContentLanguage,"Content-Langauge" },
            { RequestHeaders.ContentLocation,"Content-Location" },
            { RequestHeaders.ContentMd5,"Content-MD5" },
            { RequestHeaders.ContentRange,"Content-Range" },
            { RequestHeaders.Expires,"Expires" },
            { RequestHeaders.LastModified,"Last-Modified"},
            { RequestHeaders.Accept,"Accept" },
            { RequestHeaders.AcceptCharset,"Accept-Charset" },
            { RequestHeaders.AcceptEncoding,"Accept-Encoding" },
            { RequestHeaders.AcceptLanguage,"Accept-Langauge" },
            { RequestHeaders.Authorization,"Authorization" },
            { RequestHeaders.Cookie,"Cookie" },
            { RequestHeaders.Expect,"Expect" },
            { RequestHeaders.From,"From"},
            { RequestHeaders.Host,"Host" },
            { RequestHeaders.IfMatch,"If-Match" },
            { RequestHeaders.IfModifiedSince,"If-Modified-Since" },
            { RequestHeaders.IfNoneMatch,"If-None-Match" },
            { RequestHeaders.IfRange,"If-Range"},
            { RequestHeaders.IfUnmodifiedSince,"If-Unmodified-Since" },
            { RequestHeaders.MaxForwards,"Max-Forwards" },
            { RequestHeaders.ProxyAuthorization,"Proxy-Authorization" },
            { RequestHeaders.Referer,"Referer" },
            { RequestHeaders.Range,"Range" },
            { RequestHeaders.Te,"TE" },
            { RequestHeaders.Translate,"Translate"},
            { RequestHeaders.UserAgent,"User-Agent" },
        };
    }
}
